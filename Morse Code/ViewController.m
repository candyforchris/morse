       ...
       fromConnection:(AVCaptureConnection *)connection
{
    ...
    NSLog(@"image frame: %f by %f", image.size.height, image.size.width);
     */
    [self processCameraFrames:sampleBuffer];
...
- (void)processCameraFrames:(CMSampleBufferRef)sampleBuffer
{
